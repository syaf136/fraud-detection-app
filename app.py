...
def download_and_load_data():
    ...
    if not os.path.exists(LOCAL_PATH):
        ...
        # quiet=False shows download progress in logs
        gdown.download(url, LOCAL_PATH, quiet=False)

    # Load CSV locally (fast + stable)
    return pd.read_csv(LOCAL_PATH)

# ---- Load everything with visible progress messages ----
...
# ---- UI preview ----
st.subheader("📄 Dummy Real-time Source")
